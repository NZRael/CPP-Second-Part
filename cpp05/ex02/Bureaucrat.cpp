...
/*   Updated: 2024/04/19 16:18:23 by sboetti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm &formu) const{
	try{
		...
		std::cout << this->_name << " couldn't sign " << formu.getName() << " because " << e.what() << std::endl;
	}
}
